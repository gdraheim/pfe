...
#define __PFE_DEF_WORDS_H "%full_filespec: def-words.h~5.9:incl:bln_12xx!1 %"
 ...
 *  @version %version: 5.9 %
 *    (%date_modified: Mon Mar 12 10:33:27 2001 %)
 *
 *  @description
...
#define P4WORDS(SET)  P4CAT (SET,_LTX_p4_WORDS)
#define P4WLIST(SET)  P4CAT (SET,_LTX_p4_WLIST)
#define P4LLIST(SET)  P4CAT (SET,_LTX_p4_LLIST)
...
#define p4_DCON 'n'     /* DC */ /* dict constant (threaded) */
