...
#define __PFE_LOGGING_H "%full_filespec: logging.h~5.4:incl:bln_12xx!5 %"
 ...
 *  @version %version: 5.4 %
 *    (%date_modified: Mon Mar 12 10:33:38 2001 %)
 *
 *  @description
...
#define P4_info(str) \
  P4_LogMsg (P4_LOG_INFO, "IN.",__FUNCTION__, str)
#define P4_info1(str, x1) \
  P4_LogMsg1(P4_LOG_INFO, "IN.",__FUNCTION__, str, x1)
#define P4_info2(str, x1, x2) \
  P4_LogMsg2(P4_LOG_INFO, "IN.",__FUNCTION__, str, x1, x2)
#define P4_info3(str, x1, x2, x3) \
  P4_LogMsg3(P4_LOG_INFO, "IN.",__FUNCTION__, str, x1, x2, x3)
#define P4_info4(str, x1, x2, x3, x4) \
  P4_LogMsg4(P4_LOG_INFO, "IN.",__FUNCTION__, str, x1, x2, x3, x4)
#define P4_info5(str, x1, x2, x3, x4, x5) \
  P4_LogMsg5(P4_LOG_INFO, "IN.",__FUNCTION__, str, x1, x2, x3, x4, x5)
...
#define P4_warn( str) \
  P4_LogMsg (P4_LOG_WARN, "WA.",__FUNCTION__, str)
#define P4_warn1( str, x1) \
  P4_LogMsg1(P4_LOG_WARN, "WA.",__FUNCTION__, str, x1)
#define P4_warn2( str, x1, x2) \
  P4_LogMsg2(P4_LOG_WARN, "WA.",__FUNCTION__, str, x1, x2)
#define P4_warn3( str, x1, x2, x3) \
  P4_LogMsg3(P4_LOG_WARN, "WA.",__FUNCTION__, str, x1, x2, x3)
#define P4_warn4( str, x1, x2, x3, x4) \
  P4_LogMsg4(P4_LOG_WARN, "WA.",__FUNCTION__, str, x1, x2, x3, x4)
#define P4_warn5( str, x1, x2, x3, x4, x5) \
  P4_LogMsg5(P4_LOG_WARN, "WA.",__FUNCTION__, str, x1, x2, x3, x4, x5)
...
#define P4_fail( str) \
  P4_LogMsg (P4_LOG_FAIL, "SE.",__FUNCTION__, str)
#define P4_fail1( str, x1) \
  P4_LogMsg1(P4_LOG_FAIL, "SE.",__FUNCTION__, str, x1)
#define P4_fail2( str, x1, x2) \
  P4_LogMsg2(P4_LOG_FAIL, "SE.",__FUNCTION__, str, x1, x2)
#define P4_fail3( str, x1, x2, x3) \
  P4_LogMsg3(P4_LOG_FAIL, "SE.",__FUNCTION__, str, x1, x2, x3)
#define P4_fail4( str, x1, x2, x3, x4) \
  P4_LogMsg4(P4_LOG_FAIL, "SE.",__FUNCTION__, str, x1, x2, x3, x4)
#define P4_fail5( str, x1, x2, x3, x4, x5) \
  P4_LogMsg5(P4_LOG_FAIL, "SE.",__FUNCTION__, str, x1, x2, x3, x4, x5)
...
#define P4_fatal(str) \
  P4_LogMsg (P4_LOG_FATAL, "FA.",__FUNCTION__, str)
#define P4_fatal1(str, x1) \
  P4_LogMsg1(P4_LOG_FATAL, "FA.",__FUNCTION__, str, x1)
#define P4_fatal2(str, x1, x2) \
  P4_LogMsg2(P4_LOG_FATAL, "FA.",__FUNCTION__, str, x1, x2)
#define P4_fatal3(str, x1, x2, x3) \
  P4_LogMsg3(P4_LOG_FATAL, "FA.",__FUNCTION__, str, x1, x2, x3)
#define P4_fatal4(str, x1, x2, x3, x4) \
  P4_LogMsg4(P4_LOG_FATAL, "FA.",__FUNCTION__, str, x1, x2, x3, x4)
#define P4_fatal5(str, x1, x2, x3, x4, x5) \
  P4_LogMsg5(P4_LOG_FATAL, "FA.",__FUNCTION__, str, x1, x2, x3, x4, x5)
...
#define P4_mesg( str) \
  P4_LogMsg (P4_LOG_MESG, "XI.",__FUNCTION__, str)
#define P4_mesg1( str, x1) \
  P4_LogMsg1(P4_LOG_MESG, "XI.",__FUNCTION__, str, x1)
#define P4_mesg2( str, x1, x2) \
  P4_LogMsg2(P4_LOG_MESG, "XI.",__FUNCTION__, str, x1, x2)
#define P4_mesg3( str, x1, x2, x3) \
  P4_LogMsg3(P4_LOG_MESG, "XI.",__FUNCTION__, str, x1, x2, x3)
#define P4_mesg4( str, x1, x2, x3, x4) \
  P4_LogMsg4(P4_LOG_MESG, "XI.",__FUNCTION__, str, x1, x2, x3, x4)
#define P4_mesg5( str, x1, x2, x3, x4, x5) \
  P4_LogMsg5(P4_LOG_MESG, "XI.",__FUNCTION__, str, x1, x2, x3, x4, x5)
...
#define P4_note( str) \
  P4_LogMsg (P4_LOG_NOTE, " !_",__FUNCTION__, str)
#define P4_note1( str, x1) \
  P4_LogMsg1(P4_LOG_NOTE, " !_",__FUNCTION__, str, x1)
#define P4_note2( str, x1, x2) \
  P4_LogMsg2(P4_LOG_NOTE, " !_",__FUNCTION__, str, x1, x2)
#define P4_note3( str, x1, x2, x3) \
  P4_LogMsg3(P4_LOG_NOTE, " !_",__FUNCTION__, str, x1, x2, x3)
#define P4_note4( str, x1, x2, x3, x4) \
  P4_LogMsg4(P4_LOG_NOTE, " !_",__FUNCTION__, str, x1, x2, x3, x4)
#define P4_note5( str, x1, x2, x3, x4, x5) \
  P4_LogMsg5(P4_LOG_NOTE, " !_",__FUNCTION__, str, x1, x2, x3, x4, x5)
