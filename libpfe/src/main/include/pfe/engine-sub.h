...
#define PFE_ENGINE_SUB_H 20091022
/* generated by make-header.py from ../../c/engine-sub.c */
 ...
 */
extern void p4_call_loop (p4xt xt); /*{*/

/**
 */
extern void p4_call (p4xt xt); /*{*/

/**
 * the NEXT call. Can be replaced by p4_debug_execute to
 * trace the inner forth interpreter.
 */
extern void p4_normal_execute (p4xt xt); /*{*/
 ...
 */
extern void p4_simple_execute (p4xt xt); /*{*/

/**
 * => INTERPRET buffer
 */
extern void p4_evaluate (const p4_char_t *p, int n); /*{*/

/**
 */
extern void p4_include_file (p4_File *fid); /*{*/

/**
 * called by INCLUDED and INCLUDE
 */
extern int p4_included1 (const p4_char_t *name, int len, int throws); /*{*/

/**
 * INCLUDED
 */
extern void p4_included (const p4_char_t* name, int len); /*{*/

/**
 */
extern void p4_unnest_input (p4_Iframe *p); /*{*/

/**
 * the outer interpreter, in PFE the jumppoint for both => ABORT and => QUIT
 */
extern int p4_interpret_loop (P4_VOID); /*{*/
