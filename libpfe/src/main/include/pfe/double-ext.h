 ...
 */
extern void FXCode_RT (p4_two_constant_RT);
 ...
 * when the name is executed, these numbers are left on the stack
   ...
   0 12 ok
 */
extern void FXCode (p4_two_constant);

/** (2LITERAL) ( -- x1 x2 )
 * runtime portion of => 2LITERAL
 */
extern void FXCode_XE (p4_two_literal_execution);
 ...
 */
extern void FXCode (p4_two_literal);

extern void FXCode_RT (p4_two_variable_RT);
 ...
 * ( =>"*\/" )
 */
extern void FXCode (p4_m_star_slash);

/** "M+" ( d1.d1 n1 -- d2.d2 )
 * the double-cell mixed-operand sum operation ( => + / => D+ )
 */
extern void FXCode (p4_m_plus);
