...
-HIGHLIGHT	.(  This is again NORMAL text. ) CR
UNDERLINE	.( This text is UNDERLINEd.                   )
-UNDERLINE	.(  This is again NORMAL text. ) CR
INTENSITY	.( This text is displayed with more INTENSITY.)
-INTENSITY	.(  This is again NORMAL text. ) CR
BLINKING	.( This is BLINKING text.                     )
-BLINKING	.(  This is again NORMAL text. ) CR
REVERSE		.( This text is displayed in REVERSE video.   )
-REVERSE	.(  This is again NORMAL text. ) CR
